 <!DOCTYPE html>
  ...
  <div class="center col s6 offset-s6" 
    style="background-color: white;opacity: 0.9; height: 90%;margin-top: 5vh;align-content: center;margin-left: 25%;">
        <h4 id="reg_title"> IIIT Delhi Online Job Portal</h4>
        <h6>Already a User?</h6>
        <br>
        <a class="waves-effect waves-light btn-large pulse z-depth-5" href="login.php"><i class="material-icons left">person</i>Login</a>
        <br><br><br>
        <h6>New Registration</h6>
        <br>
        <a class="waves-effect waves-light btn-large pulse z-depth-5" href="signup.php"><i class="material-icons left">person_add</i>SignUp</a>
